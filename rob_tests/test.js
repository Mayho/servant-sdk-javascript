...
var Validator = require('./rob_validator.js');
...
test('****** Test Adding Schemas', function(t) {
	...
	var product = {
		title: 028142,
		price: 'asfj;',
		seller: 'aslkfjasl;j asj f;ajsf jas;lf j;sajf l;asjf l;asjf ;lasf as;lhf asf jal;skjf ;lasjf kla;sjf a;slfj a;sljf ',
		variations: [{
			variation: 'asfasfasfafsassjf ;lajf;lajs;lf ja;ls ja;sljf l;asjf;asljaslf',
			in_stock: true
		}, {
			variation: 'asfasfasfafsassjf ;lajf;lajs;lf ja;ls ja;sljf l;asjf;asljaslf'
		}],
	...
	try {
		Validator.validateObject(product, productSchema);
	} catch (e) {
		e = e.message || e;
